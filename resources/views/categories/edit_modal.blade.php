            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-12 mb-5">
                        ...
                        {{ Form::text('slug',null, ['class' => 'form-control','disabled','id'=>'editSlug','placeholder'=>__('messages.category.slug')]) }}
                        <input type="hidden" name="slug" id="editSlugHide">
                    </div>
                    <div class="form-group col-sm-12 mb-5">
                        {{ Form::label('name',__('messages.common.language').' :', ['class' => 'form-label required']) }}
                        {{ Form::select('lang_id', $language, null, ['class' => 'form-select', 'id' => 'languageEditId', 'placeholder' => __('messages.common.select_language'), 'data-control' => 'select2','required']) }}
                    </div>
