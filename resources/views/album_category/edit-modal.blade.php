            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="mb-5">
                        ...
                        {{ Form::select('album_id', $albums, null, ['id' => 'editAlbum','data-dropdown-parent'=>'#editAlbumCategoryModal',
                    ...
                    <div>
                        ...
                        {{ Form::select('lang_id', $languages, null, ['id' => 'editLanguage','data-dropdown-parent'=>'#editAlbumCategoryModal','class' => 'form-select', 'aria-label'=>"Select a Country",
