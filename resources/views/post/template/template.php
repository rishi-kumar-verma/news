                ...
                <div class="accordion-body border-top">
                    <div class="row">
                        <div class="col-12 mb-5">
                            ...
                            <input type="text" class="form-control form-control-solid" id="gallery_title"
                            placeholder="<?php echo __('messages.common.title') ?>" name="gallery_title[]">
                        </div>
                ...
                <div class="accordion-body border-top">
                    <div class="row">
                        <div class="col-12 mb-5">
                            ...
                            placeholder="<?php echo __('messages.common.title') ?>" name="sort_list_title[]" id="sort_list_title">
                        </div>
                        <div class="col-md-3 mt-5">
