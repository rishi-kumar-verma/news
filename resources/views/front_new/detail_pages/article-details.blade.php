                                            ...
                                            <div class="row">
                                                <div class="swiper addition-image-swiper">
                                                    <div class="swiper-wrapper">
                                                        ...
                                                        <div class="swiper-slide mx-2"><img data-src="{{$image}}" src="{{ asset('front_web/images/bg-process.png') }}" alt="" class="w-100 lazy" height="400"></div>
                                                        @endforeach
                                                    </div>
                                ...
                                <form id="commentForm">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 mb-2">
                                            @if($showCaptcha == "1")
                                                <input type="hidden" value="{{ getSettingValue()['show_captcha'] }}" id="googleCaptch">
                                                <div class="required">
                                                    <div class="col-md-6 captcha-customize">
                                                        {!! reCaptcha()->display() !!}
                                                    </div>
                                                </div>
                                            @endif
