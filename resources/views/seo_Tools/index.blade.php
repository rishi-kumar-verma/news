...
@section('content')
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-body">
                {{ Form::open(['route' => 'seo-tools.update', 'files' => true, 'id'=>'SEO_Tools_form','class'=>'form']) }}

                <div class="row mb-6">
                    {{ Form::label('lang_id',__('messages.seo-tool.language').':',['class'=>'col-lg-4 col-form-label required']) }}
                    <div class="col-lg-8">
                        {{ Form::select('lang_id', getLanguage(), !empty($seoTool->lang_id) ? $seoTool->lang_id : null , ['class' => 'form-select', 'id' => 'languageId', 'placeholder' => __('messages.common.select_language'), 'data-control' => 'select2','required']) }}
                    </div>
                </div>
                <div class="row mb-6">
