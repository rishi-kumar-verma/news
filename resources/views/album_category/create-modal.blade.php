            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="mb-5">
                        ...
                        {{ Form::select('album_id', $albums, null, ['id' => 'selectAlbum','data-dropdown-parent'=>'#createAlbumCategoryModal','class' => 'form-select', 'aria-label'=>"Select a Country",
                    ...
                    <div>
                        <div>
                            ...
                            {{ Form::select('lang_id', $languages, null, ['id' => 'selectLanguage','data-dropdown-parent'=>'#createAlbumCategoryModal','class' => 'form-select', 'aria-label'=>"Select a Country",
