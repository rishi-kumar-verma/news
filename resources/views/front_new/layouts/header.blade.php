        ...
        <div class="row align-items-center justify-content-between">
            <div class="col-lg-1 col-sm-3 col-3 ">
                <a href="/" class="top-bar-logo d-block">
                    <img src="{{asset('front_web/images/news-logo.png')}}" alt="" class="img-fluid w-100 h-100" />
                </a>
            </div>
            <div class="col-xl-7 col-md-8 col-9 ">
                <div class="row align-items-center justify-content-end  ">
                    <div class="col-xxl-4 col-lg-4 col-sm-6  br-gray  text-end  pe-xl-4 pe-lg-4 ">
                        <span class="text-secondary fs-14 pe-sm-0">{{ \Carbon\Carbon::now()->format('l, M d, Y') }}</span>
                    </div>
                    <div class="col-xl-4 col-lg-4 br-gray py-1 d-lg-block d-none ">
                        <div class="social-icon d-flex justify-content-around ">
                            <a href="{{$settings['facebook_url']}}"  target="_blank"> <i class="fa-brands fa-facebook text-secondary fs-18"></i></a>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6  d-flex flex-wrap justify-content-sm-between justify-content-end align-items-center">
                        @if(getLogInUser())
                            <div class="language-dropdown ms-2 d-none d-sm-block">
                                ...
                                <ul class="nav submenu language-menu" aria-labelledby="dropdownMenuButton1">
                                    <li class="nav-item languageSelection">
                                        <a class="nav-link fs-14 d-flex align-items-center selectLanguage" href="{{ route('admin.dashboard') }}">
                                    ...
                                    <li class="nav-item languageSelection">
                                        ...
                                        localStorage.clear();  document.getElementById('logout-form').submit();"
                                           class="nav-link fs-14 d-flex align-items-center selectLanguage"> {{ __('messages.details.logout') }}
                                        </a>
                                    </li>
                                </ul>
                            </div>
                        @else
                            <a href="{{ route('login') }}" class="fs-14 text-primary fw-6 ps-xxl-3 ps-lg-2 ps-md-1 pe-sm-0 pe-4 login-btn d-none d-sm-block">{{ __('messages.common.login') }}</a>
                        @endif
                                    ...
                                    <ul class="nav submenu language-menu">
                                        ...
                                        <li class="nav-item languageSelection" data-prefix-value="ar">
                                            <a href="javascript:void(0)"
                                               class="nav-link fs-14 d-flex align-items-center selectLanguage @if(getFrontSelectLanguageName()
                                           == $language) active @endif"  data-id="{{ $key }}">
                                                {{ $language }}
                                            </a>
                                        </li>
                                        @endforeach
                        ...
                        <div class="offcanvas-toggle d-lg-none d-block">
                            ...
                            <div class="offcanvas-wrapper offcanvas-wrapper-start" tabindex="-1"
                                ...
                                <div class="offcanvas-content m-0">
                                    ...
                                    @else
                                        <div class="set">
                                            <a href="{{ route('login') }}" class="fs-14 fw-6 {{ 'Contact' == ucfirst(last(request()->segments())) ? 'active': '' }}">
