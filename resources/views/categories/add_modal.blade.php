    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-12 mb-5">
                        ...
                        {{ Form::text('slug',null, ['class' => 'form-control','disabled','id'=>'slug','placeholder'=>__('messages.category.slug')]) }}
                        <input type="hidden" name="slug" id="slugHide">
                    </div>
                    <div class="form-group col-sm-12 mb-5">
                        {{ Form::label('name',__('messages.common.language').' :', ['class' => 'form-label required']) }}
                        {{ Form::select('lang_id', $language, null, ['class' => 'form-select', 'id' => 'languageId', 'placeholder' => __('messages.common.select_language'), 'data-control' => 'select2','required']) }}
                    </div>
            ...
            <div class="modal-footer pt-0">
                {{ Form::button(__('messages.common.save'), ['type' => 'submit','class' => 'btn btn-primary me-2','id' => 'catBtnSave','data-loading-text' => "<span class='spinner-border spinner-border-sm'></span> Processing..."]) }}
