...
class PostRepository extends BaseRepository
{
    ...
    public function store($input)
    {
        ...
        try {
            ...
            if ($input['post_types'] == Post::ARTICLE_TYPE_ACTIVE) {
    ...
    public function update($input, $id): bool
    {
        try {
            ...
            $input['show_on_headline'] = (isset($input['show_on_headline'])) ? Post::
            HEADLINE_ACTIVE : Post::HEADLINE_DEACTIVE;
    ...
    {
        $postGalleryArray = Arr::only($input,
            ['gallery_title', 'image_description', 'gallery_content', 'gallery_images', 'gallery_image_remove', 'gallery_id']);
        ...
        foreach ($galleryItemInputs as $key => $data) {
            ...
            } else if($data['gallery_title'] != null || $data['image_description'] != null || $data['gallery_content'] != null){
    ...
    public function postSortListUpdate($input, $post)
    {
        ...
        foreach ($sortListItemInputs as $key => $data) {
            ...
            } else if($data['sort_list_title'] != null || $data['image_description'] != null || $data['sort_list_content'] != null) {
