<div class="row gx-10 mb-5">
    <div class="col-lg-12 row">
        ...
        <div class="mb-5 col-lg-6">
            ...
            {{ Form::text('title', isset($page) ? $page->title : null, ['class' => 'form-control form-control-solid','required','placeholder' =>__('messages.page.title'),'id'=>'titlePage']) }}
        </div>
        <div class="mb-5 col-lg-12">
            ...
            <input type="hidden" name="slug" id="slugHidden"  value="{{ isset($page) ? $page->slug : null}}">
        </div>
        <div class="mb-5 col-lg-6">
        ...
        <div class="mb-5 col-lg-6">
            ...
            {{ Form::select('lang_id', getLanguage(), isset($page) ? $page->lang_id :null, ['class' => 'form-select form-select-solid', 'id' => 'languageId', 'placeholder' => __('messages.page.add_lang'), 'data-control' => 'select2','required']) }}
        </div>
    ...
    <button type="button" class="col-md-2 btn btn-primary mb-4 btn-add-image">
        {{__('messages.post.add_image')}}
    </button>
    <textarea id="kt_docs_tinymce_plugins" name="content" class="tox-target text-description">
      {!! $page->content??null !!}
    </textarea>
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <input type="file" class="form-control" id="newImage" name="image" accept=".png, .jpg, .jpeg">
                ...
                <div class="modal-footer p-2 d-none justify-content-between">
                    <div>
                        <button type="button"
                                class="btn btn-danger  image-delete-btn">{{__('messages.delete')}}</button>
                    </div>
                    <button type="button"
